...
with tab_tabla:
    ...
    column_config = {
        ...
        "Desvío ventas 4 sem.": st.column_config.NumberColumn(format="%.1f"),
        "Desvío ventas 8 sem.": st.column_config.NumberColumn(format="%.1f"),
        "Desvío ventas 12 sem.": st.column_config.NumberColumn(format="%.1f"),
